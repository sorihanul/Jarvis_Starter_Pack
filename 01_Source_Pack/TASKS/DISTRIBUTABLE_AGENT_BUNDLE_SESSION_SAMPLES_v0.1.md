# Distributable Agent Bundle Session Dryruns

- date: 2026-03-26
- purpose: verify that the new distributable agent cards still read cleanly when paired with a session card and matching skills

## Method

- use one minimal session card per lane
- assign the recommended bundle from `TASKS/DISTRIBUTABLE_AGENT_SKILL_BUNDLES_v0.1.md`
...
- agent: `AGENTS/agent_distributable_intake_router.md`
- skills:
...
## Case 4. Distributable Research Bundle
...
- session_name: distributable-research-demo
- session_type: research
- purpose: 배포 문서를 조사해 근거와 남은 불확실성을 정리한다
...
- agent: `AGENTS/agent_distributable_research_specialist.md`
- skills:
...
- result: pass
- why:
  - this is the clean distributable-generic research lane
...
## Case 6. Distributable Coding Bundle
...
- session_name: distributable-coding-demo
- session_type: coding
...
- agent: `AGENTS/agent_distributable_coding_specialist.md`
- skills:
...
- result: strong pass
- why:
  - this is the current best distributable coding default
...
- handoff_to: chief or distributable coding specialist
...
## Case 8. Distributable Writing Bundle
...
- session_name: distributable-writing-demo
...
- agent: `AGENTS/agent_distributable_writing_specialist.md`
- skills:
...
- `research` bundles are complete enough to compare distributable vs AILO-E lanes
- `coding` bundles now read clearly as:
  - `distributable coding specialist` for default patch lane
  - `AILO-E code worker` for blocker-honest bounded work
- `writing` bundle is coherent and lightweight

## Working Verdict

- the new distributable agent cards no longer float alone
- once the matching skills are added, the bundles read as an actual operating system layer
- next useful step:
  - run repeated session-card pilots for `distributable coding specialist`, `distributable writing specialist`, and `distributable intake router`

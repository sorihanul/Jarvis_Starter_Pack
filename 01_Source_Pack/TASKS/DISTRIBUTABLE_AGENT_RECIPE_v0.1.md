# Distributable Agent Recipe v0.1

## Purpose

- define how to write a distributable-safe agent card inside Jarvis Starter
- keep agent cards small, readable, and operational for model-first use

## When To Use This Recipe

- when adding a new distributable agent under `AGENTS/`
...
- a distributable agent card must define a lane, not a personality blob
- it should answer:
...
## Distributable Default Bias

- coding specialist:
  - default to distributable non-AILO shape
- writing specialist:
  - default to distributable non-AILO shape
...
- a distributable agent card should be a small operating lane with a clear contract, not a grand theory blob

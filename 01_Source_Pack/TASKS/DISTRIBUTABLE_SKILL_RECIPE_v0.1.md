# Distributable Skill Recipe v0.1

## Purpose

- define how to write a distributable-safe skill card inside Jarvis Starter
...
## Good Distributable Skill Targets
...
- a distributable skill should be a small reusable move that tightens a lane, not a second hidden agent

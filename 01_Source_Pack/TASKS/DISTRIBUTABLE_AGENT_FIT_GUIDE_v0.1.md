# Distributable Agent Fit Guide

- date: 2026-03-26
- purpose: clarify which distributable agent form fits which task class in Jarvis Starter
...
- choose `non-AILO` when:
  ...
  - language should stay flatter and more distributable-generic

## Current Status

- this guide is a working selection guide
- it is meant to help the starter choose the right distributable agent form by task shape
...
- if the coding task needs:
  ...
  - distributable-generic language

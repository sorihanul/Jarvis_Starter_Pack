...
03_AILO_Function_System/
  ...
  AILO_RELATION_TOPOLOGY_PACK_v0_1.md
...
Use `AILO_RELATION_TOPOLOGY_PACK_v0_1.md` only when a mini ontology needs optional `topo` hints for relation-network structure. `topo` does not replace relation slots, evidence, state, authority, or execution.
